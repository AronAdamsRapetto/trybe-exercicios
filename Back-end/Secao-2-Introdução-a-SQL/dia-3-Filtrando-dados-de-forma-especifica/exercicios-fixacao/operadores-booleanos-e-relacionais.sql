...
-- O setor financeiro quer saber título, descrição,
-- ano de lançamento e valor do custo de substituição (replacement_cost),
...
-- para que possamos fazer uma divulgação melhor desses filmes. Em caso de empate,
