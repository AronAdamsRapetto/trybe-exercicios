...
-- Corrija para $25 o valor do aluguel da tabela filmes com duração maior que 100 minutos e que possuem classificação "G", 
...
-- Agora, o aluguel dos filmes com duração entre 0 e 100 minutos passará a ser $10,00 e o aluguel dos filmes com duração acima de 
-- 100 minutos passará a ser de $20,00.
UPDATE film
SET rental_rate = (
CASE WHEN length BETWEEN 0 AND 100 THEN 10.00
ELSE 20.00
END);
