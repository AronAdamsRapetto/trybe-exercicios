...
describe('Descrição geral de simulação - Teste a função fetchCharacter', () => {
  it('Descrição da simulação - Teste assíncrono', async () => {
    const character = await fetchCharacter('720');
    expect(character.name).toBe('Wonder Woman');
  });
  it('Testa o erro se for passada a função sem parametrô', async () => {
