...
class CalculadoraDecoradaEnglish(CalculadoraDecorada):
    def converterNumero(self, numero):
        if not isinstance(numero, str):
            return numero
...
if __name__ == "__main__":
    ...
    calculadoraDecorada2 = CalculadoraDecoradaEnglish(calculadora)
    print("'eight' + 'two' =", calculadoraDecorada2.soma("eight", "two"))
